      ...
      <div class="container">
        <div class="row align-items-center row-login">
          <div class="col-lg-6 text-center">
            <img src=" {{asset('template_admin')}}/images/pm2.png" alt="logo" class="w-50 mb-4 mb-lg-none">
          </div>
          <div class="col-lg-5">
            <h2>Belanja Kebutuhan Utama Menjadi Mudah</h2> <br>
            <form method="POST" action="{{ route('login') }}" class="mt-3">
              ...
              <button type="submit" class="btn btn-signup btn-block w-75 mt-4">Sign In To My Account</button>
              <a href="{{route('register')}}" class="btn btn-signup btn-block w-75 mt-4">SignUp</a>
            </form>
          </div>
        </div>
      </div>
