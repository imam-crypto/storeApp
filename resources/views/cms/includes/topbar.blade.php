                        ...
                        <ul class="nav navbar-nav pull-right">
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('template')}}/assets/layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="{{asset('template')}}/assets/layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="username username-hide-mobile">Prabs</span>
                                </a>
                    ...
                    <div class="hor-menu  ">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-dropdown mega-menu-dropdown  mega-menu-full">
                                <a href="javascript:;"> Data Management
                                    <span class="arrow"></span>
                                </a>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <ul class="mega-menu-submenu">
                                                        ...
                                                        <li>
                                                            <a href="{{route('user.index')}}" class="nav-link"> <i class="icon-user"></i> Data User </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{route('home')}}" class="nav-link"> <i class="icon-picture"></i> Data Banner </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-3">
                                                    <ul class="mega-menu-submenu">
                                                        ...
                                                        <li>
                                                            <a href="{{route('category.index')}}" class="nav-link"><i class="icon-diamond"></i> Data Category </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-3">
                                                    <ul class="mega-menu-submenu">
                                                        ...
                                                        <li>
                                                            <a href="{{route('product.index')}}"><i class="icon-layers"> </i> Data Product </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{route('product_gallery.index')}}"> <i class="icon-star"> </i> Data Product Gallery </a>
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            {{-- <li class="menu-dropdown mega-menu-dropdown">
                                ...
                                <ul class="dropdown-menu pull-left" >
                                    ...
                                    <li>
                                        <a href="{{route('home')}}"> <i class="icon-star"> </i> Data Brand </a>
                                    </li>
                                    <li>
                                        <a href="{{route('product.index')}}"><i class="icon-layers"> </i> Data Product </a>
                                    </li>
