...
@endif    
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="btn-group">
                    <a href="{{route('product_gallery.create')}}" id="sample_editable_1_new" class="btn sbold green">  <i class="fa fa-plus"></i>Add New Gallery Product
                    </a>
                </div>
                <div class="actions">
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ url('storage/' .$dt->photos) }}" style="max-height: 90px; max-width: 120px;" alt="photo"></td>
