                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dashboard-stat blue">
                            ...
                            <div class="details">
                                ...
                                <div class="desc"> Infaq Masuk Dari Parkir </div>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="dashboard-stat red">
                            ...
                            <div class="details">
                                ...
                                <div class="desc"> Total Donat Orders </div>
                            </div>
                            <a class="more" href="javascript:;"> View more
                                <i class="m-icon-swapright m-icon-white"></i>
                            </a>
                                        ...
                                        <div class="item">
                                            <div class="item-head">
                                                <div class="item-details">
                                                    ...
                                                    <a href="" class="item-name primary-link">Prabs</a>
...
@endsection
@push('before-script')
<script src="{{asset('template_admin/plugins/highcart')}}/highcharts.js"></script>
<script src="{{asset('template_admin/plugins/highcart')}}/highcharts-more.js"></script>
<script src="{{asset('template_admin/plugins/highcart')}}/exporting.js"></script>
<script src="{{asset('template_admin/plugins/highcart')}}/export-data.js"></script>
<script src="{{asset('template_admin/plugins/highcart')}}/accessibility.js"></script>
@endpush
@push('after-script')
...
Highcharts.chart('container2', {
    ...
    plotOptions: {
        pie: {
            ...
            dataLabels:{
                enabled:true,
                format:'<b>category</b>:{point.percentage:.1f}%'
            }
        }
    },
    series: [{
