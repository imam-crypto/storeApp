...
@endif    
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="btn-group">
                    <a href="{{route('category.create')}}" id="sample_editable_1_new" class="btn sbold green" data-toggle="modal">  <i class="fa fa-plus"></i>Add New Category
                    </a>
                </div>
                <div class="actions">
                                ...
                                {{-- <a href="{{route('category.edit',$dt->id)}}" class="btn btn-xs green">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            <li>
                                                <a href="{{route('category.edit',$dt->id)}}">
